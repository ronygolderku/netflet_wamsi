...
dataset = Dataset('./netcdf/Mercator_20210316_20210319.nc')
print(dataset)
...
print(dataset.variables[v_var].dimensions, dataset.variables[temp_var].shape)
...
lons_sm = lons.reshape(-1, group2).mean(axis=1)
...
temps_sm = np.array(temp_array).reshape(-1, (group * group2)).mean(axis=1)
